...
export default function About(){
    return(
        <div id="about" className="pt-44 px-10 md:p-24 h-auto">
          <div className="text-center md:p-16 " >
            <h1 className="text-xl md:text-5xl text-teal-600 font-medium">Tugba Yildiz</h1>
          ...
          <div className="text-5xl flex justify-center gap-16 py-9 md:py-3 text-gray-600 ">
